...
\emph{Compared with random placement policy, hybrid placement can guarantee similar network performance.}

\emph{Hybrid placement can mitigate the performance degradation of less communication-intensive application. } Unlike random placement which indulge ``bully", hybrid placement can restrain it to some extent.
