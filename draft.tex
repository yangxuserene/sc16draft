...
In this section, we will verify the observations made in the previous section by experimenting with Workload \Rmnum{1 } running on our dragonfly network under different placement and routing configurations. By generating a synthetic application, we turn a ``bully" into a ``bullee". 
