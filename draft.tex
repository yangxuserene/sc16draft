...
\begin{figure*}[t!]
    ...
    \end{subfigure}%
   \caption{Network Channel Busy Time.}
   \label{fig:wkld-network-stime}
\end{figure*}

Figure \ref{fig:wkld-network-traffic} and Figure \ref{fig:wkld-network-stime} shows that random job placement with adaptive routing can distribute workload traffic and balance the load over the network. Contiguous job placement 
...
Figure \ref{fig:apps-commtime} shows the communication time of three applications running concurrently with 4 different placement and routing configurations. MG and CR can get improvement with random placement and adaptive routing, compared with contiguous placement and minimal routing. However, AMG's performance is impacted with random placement and adaptive routing, which makes it an exception from other applications. 
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[height=1.8 in]{syn-wkld/amg10/lc-traffic}
        \caption{AMG Local Channel Traffic}
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[height=1.8 in]{syn-wkld/mg/lc-traffic}
        \caption{MG Local Channel Traffic}
        \label{fig:syn-mg-lc-traffic}
    \end{subfigure}%
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[height=1.8 in]{syn-wkld/cr/lc-traffic}
        \caption{CR Local Channel Traffic}
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[height=1.8 in]{syn-wkld/amg10/gc-traffic}
        \caption{AMG Global Channel Traffic}
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[height=1.8 in]{syn-wkld/mg/gc-traffic}
        \caption{MG Global Channel Traffic}
        \label{fig:syn-mg-gc-traffic}
    \end{subfigure}%
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[height=1.8 in]{syn-wkld/cr/gc-traffic}
        \caption{CR Global Channel Traffic}
