...
We have observed that the performance improvement of communication-intensive jobs comes with the sacrifice of less intensive jobs. 
We identify this ``bully" behavior with the help of detailed network simulation and real application traces and validate the underneath causes.
We propose a hybrid job placement policy that provide either contiguous or random allocation to each application based on its communication intensity. 
With the help of the simulation, we demonstrate that this hybrid job placement policy can lead to performance improvement for less communication-intensive applications.
