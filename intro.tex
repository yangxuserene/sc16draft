...
The high-radix, low-diameter dragonfly topology can lower \NOTE{the extension cost?} of the interconnect, improve network bandwidth and reduce packet latency \cite{dally-dragonfly}, 
